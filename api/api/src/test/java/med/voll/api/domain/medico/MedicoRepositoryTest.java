...
public class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria null quando o unico medico cadastrado nao esta disponivel na data")
    void testEscolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var paciente = cadastrarPaciente("Paciente", "paciente@test.com", "12345678901");
